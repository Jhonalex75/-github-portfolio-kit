...
export const MILL_ASSEMBLY_PLANS: Record<string, StaticAssemblyStep[]> = {
  ...
  "ESP-CON-001": [
    {
      step_number: 1,
      title: "Actividades Preliminares",
      description: "Recepción e inspección de todos los componentes contra packing list del fabricante Metso (ES-LX-OU500911029_R0_IOMS). Verificación de estado de preservación; almacenamiento de componentes engomados protegidos de rayos UV. Verificación topográfica de fundaciones civiles y pernos de anclaje (altura ±10 mm, distancia entre pernos ±3 mm a ±6 mm). Liberación formal de anclajes y áreas. Planificación de izajes. Ref.: LM-HLGS-C-1000-3940-FRM-0005 (Topografía) · Proc.: LM-HLGS-C-1000-3940-PRO-0034.",
      weight_pct: 5,
    ...
    {
      step_number: 2,
      title: "Instalación de Underflow (Bota de Descarga Inferior)",
      description: "Pre-ensamble e instalación del Underflow Boot (cono de descarga inferior) sobre la base civil. Verificación de orientación de boquillas de underflow respecto a la brida de descarga. Alineación y torqueo de pernos de anclaje conforme a tabla de torques del fabricante. Este componente establece la referencia geométrica central para todas las etapas posteriores.",
      weight_pct: 5,
      iom_ref: "OU500911039 §4.2 — Underflow Boot",
      proc_ref: "LM-HLGS-C-1000-3940-PRO-0034 §4.3",
    },
    {
      step_number: 3,
      title: "Instalación de Columnas / Estructura Soporte",
      description: "Instalación del Anillo de Compresión: verificación de orientación de boquillas y pedestales, geometría radial en 16 puntos cada 22,5°. Izaje, posicionamiento y verticalización de columnas (tolerancia estricta L/500). Instalación de arriostramientos cruzados (Cross Bracing) y elementos de rigidización. Nivelación y torqueo progresivo de pernos de anclaje según tabla de torques del fabricante.",
      weight_pct: 10,
      iom_ref: "OU500911039 §4.3 — Support Structure",
      proc_ref: "LM-HLGS-C-1000-3940-PRO-0034 §4.4",
    },
    {
      step_number: 4,
      title: "Instalación de Piso y Pared del Tanque",
      description: "Pre-ensamble en suelo de hasta 8 secciones de piso para minimizar trabajo en alturas. Instalación de vigas radiales sobre las columnas. Montaje de segmentos de piso y segmentos superiores del manto (Shell Plates). NOTA: todos los pernos se instalan en condición snug tight (sin torque final en esta fase). Atornillado definitivo: prueba de lubricación de pernos (giro 300°) y torque final con arandelas Squirter Washers (1:25 pernos) método giro de tuerca. Preparación de superficies (Sika Aktivator-205) y sellado de juntas con Sikaflex 221. Ref.: LM-HLGS-C-1000-3940-FRM-0021 (Torque).",
      weight_pct: 20,
    ...
    {
      step_number: 5,
      title: "Instalación del Puente",
      description: "Ensamble de módulos del puente en suelo y verificación de contraflecha (Precamber positivo 55–65 mm). Izaje del puente completo; centrado con 4 plomadas respecto al underflow (offsets Z1, Z2, Z3, Z4 — tolerancia ±20 mm entre ellas). Descenso e instalación del Drive Unit sobre la brida central con torque en estrella de 1 440 Nm.",
      weight_pct: 10,
    ...
    {
      step_number: 6,
      title: "Instalación de Mecanismo de Giro y Rastras",
      description: "Instalación vertical del Drive Shaft, soportado temporalmente 100 mm por encima de la cota final (desviación máxima 5 mm). Montaje de brazos cortos y largos (Short & Long Rake Arms) y puntales (Struts) con Shim Packs preliminares. Instalación del Steady Pin y Steady Bearing; holgura nominal del rodamiento: 25 mm (pasador sin contacto con rodamiento). Cálculo y ajuste del offset del pasador según marcas de contacto; torque final del Steady Pin. Rotación del mecanismo 360° mediante HPU para verificar giro libre. Ref.: LM-HLGS-C-1000-3940-FRM-0110 (Alineación).",
      weight_pct: 10,
    ...
    {
      step_number: 7,
      title: "Instalación de Componentes de Alimentación",
      description: "Pre-ensamble e instalación del Feedwell (Metso Reactorwell™) suspendido debajo del puente. Instalación de cono deflector, scraper y accesorios misceláneos; verificación de holguras. Conexión de tubería de alimentación, caja de transición, tuberías de floculante y aspersores. Nivelación final de brazos de rastra: diferencia máxima en punta de brazos largos ≤ 25 mm y brazos cortos ≤ 15 mm (ajuste definitivo de Shim Packs).",
      weight_pct: 10,
    ...
    {
      step_number: 8,
      title: "Verificación de Tolerancias",
      description: "Verificación de todas las tolerancias mecánicas del espesador ensamblado: verticalidad de columnas (L/500), nivel del tanque, holguras de rastras (brazos largos ≤ 25 mm, brazos cortos ≤ 15 mm), contraflecha del puente (55–65 mm), offset del Steady Pin y torqueo estructural. Aprobación de protocolos QC: LM-HLGS-C-1000-3940-FRM-0005 (Topografía), FRM-0110 (Alineación), FRM-0021 (Torque). PARTIDA BMP INDEPENDIENTE — 10% del total. Ref.: LM-ED-MEL-3410-3400-0001.",
      weight_pct: 10,
      iom_ref: "OU500911039 §8 — Final Verification",
      proc_ref: "LM-HLGS-C-1000-3940-PRO-0034 §4.9",
    },
    {
      step_number: 9,
      title: "Pruebas Funcionales",
      description: "Pre-comisionamiento en seco: giro manual de rastras para verificar libre movimiento; prueba HPU (levantamiento hidráulico de emergencia y verificación de sentido de rotación). Prueba de estanqueidad: llenado con agua mínimo 24 h, inspección de fugas en juntas, boquillas y fondo. Verificación de torque de rastra girando sumergido; medición de torque de arranque vs. nominal del fabricante. PARTIDA BMP INDEPENDIENTE — 10% del total. Ref.: LM-ED-MEL-3410-3400-0001.",
      weight_pct: 10,
      iom_ref: "OU500911039 Anexo 1 §A1 — Functional Tests",
      proc_ref: "LM-HLGS-C-1000-3940-PRO-0034 §4.10",
    },
    {
      step_number: 10,
      title: "Protocolos de Entrega del Equipo",
      description: "Reemplazo del aceite de prueba del reductor y HPU por aceite definitivo según especificación del fabricante. Entrega de tarjeta de lubricación. Entrega formal del dossier de calidad: ITPs firmados, registros de torqueo, protocolos de topografía y alineación, certificado de prueba hidráulica y manual de O&M Metso. HITO FINAL — Mechanical Completion. No completado hasta firma de todos los protocolos por SGS|ETSA y Aris Mining. PARTIDA BMP INDEPENDIENTE — 10% del total. Ref.: LM-ED-MEL-3410-3400-0001.",
      weight_pct: 10,
      iom_ref: "OU500911039 §9 — Handover Protocols",
