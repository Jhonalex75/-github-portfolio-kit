...
export const PLANT_EQUIPMENT: PlantEquipment[] = [
  ...
  {
    tag: "ESP-CON-001",
    name: "Espesador de Concentrado",
    areaCode: "1800",
    areaName: "Espesadores y Filtros",
    category: "espesador",
    description: "Espesador de alta compresión (HC) para concentrado final, diámetro 18m, con rastrillo central y descarga por bomba",
    discipline: "Mecánica / Civil",
    typicalManufacturer: "FLSmidth (Supaflo) / Metso",
  },
  {
    tag: "ESP-REL-001",
